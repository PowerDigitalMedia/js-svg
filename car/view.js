...
function SVG_ViewCar(parent_id){




	//parent document is the element you want to append the svg build graphic to
...
//######################################################################################################
	...
	var CAR_BODY_COLOR = '#E6E7E8';
	var CAR_ACCENT_COLOR = 'red';
	...
	if(CAR_ACCENT_COLOR
	&& CAR_ACCENT_COLOR != undefined
	)
	{
		var caraccent_color = CAR_ACCENT_COLOR;
	}else{
